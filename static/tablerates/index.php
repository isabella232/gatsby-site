...
<link rel="shortcut icon" href="http://elgentos.nl/misc/favicon.ico" type="image/vnd.microsoft.icon" />
...
<br />
<input type="button" name="button" onclick="checkOutsideEU()" value="Check all countries outside European Union" />
<br />
<input type="button" name="button" onclick="checkEuro()" value="Check all European countries" />
<br />
<input type="button" name="button" onclick="checkOutsideEuro()" value="Check all countries outside Europe" />
<br /><br />
<input type="button" name="button" onclick="addRowSelectedCountries()" value="Add empty row to selected countries" />
<br />
...
<ul>
<li><table><tr><th style="width:350px;">Country</th><th>Shipping Costs&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span id="conditionLabel">From subtotal</span></th><th>&nbsp;</th></tr></table></li>
<?php
...
foreach($c as $d) {
    ...
    <li>
        <table>
            <tr>
                <td style="width: 350px;"><input type='checkbox' name='country_<?=$countryCode;?>[]' value='<?=$countryCode;?>' id='country_<?=$countryCode;?>' /> <label><?=$parts[1];?></label></td>
